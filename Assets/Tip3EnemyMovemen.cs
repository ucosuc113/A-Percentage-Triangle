...
public class HomingEnemy : MonoBehaviour
{
    ...
    public float waitTimeBeforeNextTarget = 0.5f;
    ...
    void Start()
    {
        ...
        {
            Transform randomSpawn = collisionsParent.GetChild(Random.Range(0, collisionsParent.childCount));
    ...
    void Update()
    {
        if (!moving)
        {
            ...
            if (waitTimer >= waitTimeBeforeNextTarget)
            {
                SetNewTarget();
                waitTimer = 0f;
            }
